...
import ExpiringContractListPage from './pages/expiringContracts/ExpiringContractListPage';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={<PrivateRoute user={user}><ExpiringContractListPage /></PrivateRoute>}
        />
      </Routes>
    </BrowserRouter>
  );
